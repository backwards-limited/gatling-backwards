...
class Simulation7SetupClosedSystem extends Simulation{
  ...
  setUp(
    scenario1.inject(rampConcurrentUsers(0) to 6 during(10 seconds), constantConcurrentUsers(6) during(1 minute)),
    scenario2.inject(rampConcurrentUsers(0) to 4 during(10 seconds), constantConcurrentUsers(4) during(1 minute))
