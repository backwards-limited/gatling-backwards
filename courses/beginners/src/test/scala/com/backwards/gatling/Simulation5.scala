...
class Simulation5 extends Simulation with Constants {
  ...
  val csvFeeder: SourceFeederBuilder[String] = csv("data/passengers.csv")

  val randomEmailFeeder = Iterator.continually(Map("randomEmail" -> (Random.alphanumeric.take(20).mkString + "@gmail.com")))
